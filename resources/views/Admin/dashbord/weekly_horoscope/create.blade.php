...
<div class="container-fluid px-4">
    <h1 class="mt-4">Add Weekly Horoscope</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Horoscope Management / Add Weekly Horoscope</li>
    </ol>

    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.weekly.horoscope.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="weekly_id" id="weekly_id" class="form-control" required>
                        ...
                        @foreach ($weeklies as $weekly)
                            <option value="{{ $weekly->id }}">Week {{ $weekly->weekly }} - {{ $weekly->year }}</option> <!-- Adjust as necessary -->
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="warnings" id="warnings" class="form-control" rows="3" required></textarea>
                </div>

                <button type="submit" class="btn btn-primary">Add Weekly Horoscope</button>
            </form>
        </div>
    </div>
</div>
