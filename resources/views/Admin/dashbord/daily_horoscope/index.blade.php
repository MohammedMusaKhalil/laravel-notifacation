...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Horoscope Management / Daily Horoscope</li>
    </ol>
    ...
    <div class="mb-3">
        <a href="{{ route('admin.daily.horoscope.create') }}" class="btn btn-primary">Add New Horoscope</a>
    </div>

    <div class="row">
        <div class="col-md-12">
            <h3>Today's Horoscopes</h3>
                    ...
                    <tbody>
                        @foreach ($horoscopes as $horoscope)
                            <tr>
                                ...
                                <td>{{ optional($horoscope->daily)->date }}</td>
                                ...
                                <td>
                                    <a href="{{ route('admin.daily.horoscope.edit', $horoscope->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="{{ route('admin.daily.horoscope.destroy', $horoscope->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
