...
@section('content')
    <form action="{{route('admin.register')}}" method="POST" >
        ...
        <div class="form-floating">
            <input type="text" name="name" :value="old('email')"  class="form-control" id="floatingInput" placeholder="Enter Your Name">
            <label for="floatingInput">Name</label>
            <x-input-error :messages="$errors->get('name')" class="mt-2 text-start text-denger small" />
        </div>
        ...
        <div class="form-floating">
            ...
            <label for="floatingPassword">Password</label>
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 text-start text-denger small" />
        </div>
